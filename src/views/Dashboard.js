      ...
      <Container fluid>
        ...
        <Row>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Call Statistics</Card.Title>
              ...
              <Card.Body>
                ...
                <div className="legend">
                  <i className="fas fa-circle text-info"></i>
                  Spam <i className="fas fa-circle text-danger"></i>
                  Legitimate <i className="fas fa-circle text-warning"></i>
                  Warning{" "}
                  <i className="fas fa-circle" style={{ color: "purple" }}></i>
                  Phishing
                </div>
                <hr></hr>
                <div className="stats">
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Message Statistics</Card.Title>
                <p className="card-category">Last Campaign Performance</p>
              </Card.Header>
              <Card.Body>
                <div
